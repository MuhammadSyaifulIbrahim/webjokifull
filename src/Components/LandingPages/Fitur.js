        ...
        <Row className="health-row">
          <Col xs={12} md={6} lg={3}>
            <div className="column-content1">
              <img width={"100%"} src={gambar1} alt="Gambar 1" />
          ...
          <Col xs={12} md={6} lg={3}>
            <div className="column-content1">
              <img width={"100%"} src={gambar2} alt="Gambar 2" />
          ...
          <Col xs={12} md={6} lg={3}>
            <div className="column-content1">
              <img width={"100%"} src={image3} alt="Gambar 3" />
          ...
          <Col xs={12} md={6} lg={3}>
            <div className="column-content1">
              <img width={"100%"} src={gambar4} alt="Gambar 4" />
